...
namespace VERIFY
{
    public partial class Form1 : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            string updatedRecord = $"ID:{idToUpdate}|FirstName:{txtFirstName.Text.Trim()}|LastName:{txtLastName.Text.Trim()}|MiddleName:{txtMiddleName.Text.Trim()}|Course:{txtCourse.Text.Trim()}|YearLevel:{txtYearLevel.Text.Trim()}|Birthday:{dtpBirthday.Value:yyyy/MM/dd}";
